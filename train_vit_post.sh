...
results_path='/home/GRAMES.POLYMTL.CA/u114716/neural_scaling_laws/nsl-project/results' 
echo "###### POST-NORM EXPERIMENT STARTED ########"
CUDA_VISIBLE_DEVICES=0,1 python run_exp_vit_pl.py -ngpus 2 --dataset imagenette --model vit --layers 12 --block postnorm -bs 16 -ps 8 --epochs 200 --opt adamw --exp_id imgnet_12_post_bs=16_ps=4_ep=200_adamw --log_dir $results_path 
echo "###### POST-NORM EXPERIMENT ENDED ########"
echo " "
