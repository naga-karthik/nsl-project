...
python run_exp_vit.py --model vit --layers 2 --batch_size 128 --epochs 1 --optimizer adam --exp_id exp1 --log --log_dir /home/mila/v/venkatesh.ramesh/scratch/as2/IFT6135-2/assignment2/logs_vit
python run_exp_vit.py --model vit --layers 2 --batch_size 128 --epochs 1 --optimizer adamw --exp_id exp2 --log --log_dir /home/mila/v/venkatesh.ramesh/scratch/as2/IFT6135-2/assignment2/logs_vit
